                ...
                <blockquote className="blockquote mb-0">
                    ...
                    <ul>
                        <li className="about-activity">
                            <HiOutlineChevronDoubleRight /> Aprender nuevas tecnologías y buenas prácticas
                        </li>
                        <li className="about-activity">
                            <HiOutlineChevronDoubleRight /> Desarrollar proyectos personales para mi
                            portfolio
                        </li>
                        <li className="about-activity">
                            <HiOutlineChevronDoubleRight /> Explicar y ayudar a otros cuando lo necesitan
                        </li>
                        <li className="about-activity">
                            <HiOutlineChevronDoubleRight /> Trabajar en equipo para alcanzar un objetivo en
                            común
                        </li>
                    </ul>
